...
class PlayState extends MusicBeatState
{
	...
	{
		inCutscene = true;
		FlxG.sound.play(Paths.sound('swapsound'), 1, false, null, true);
	...
	private function generateStaticArrows(player:Int):Void
	{
		for (i in 0...4)
		{
			...
			switch (noteTypeCheck)
			{
				...
				case 'beatsaber':
					babyArrow.frames = Paths.getSparrowAtlas('BS_NOTE_assets');
					for (j in 0...4)
					{
